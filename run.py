...
if __name__ == '__main__':
  ...
  if not args.seconds:
    print (colored("Error: Chưa Set thời gian nghe. Nên để mặc định 10s", "yellow"))
    args.seconds = "10"
  ...
  while True:
    ...
    print (colored("Đang lắng nghe....","green"))
  ...
  print (colored('Okey, Nghe đủ r :v', attrs=['dark']))
  ...
  def return_matches(hashes):
    ...
    for split_values in grouper(values, 1000):
      ...
      matches_found = len(x)
      if matches_found > 0:
        msg = 'Đã tìm thấy %d hash trong db'
